    ...
    function(error, result) { 
      ...
      data.histories.push({        
       ...
       res
          ...
          .end('<head><script src="https://code.jquery.com/jquery.js"></script><script>$(document).ready(function() {$(location).attr("href", "/history2")});</script></head>')
